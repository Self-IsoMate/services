...
<meta charset="utf-8">
  ...
  <title>Self-IsoMate Reset password</title>
...
<body style="background-color: #e9ecef;">
  ...
  <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
    Welcome to Self-Isomate, please confirm email address  </div>
  <!-- end preheader -->
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
              <a href="http://www.self-isomate.online/" target="_blank" style="display: inline-block;">
                <img src="http://www.self-isomate.online/assets/img/tech/image4.jpg" alt="Logo"  width="48" style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
              </a>
            </td>
          </tr>
        </table>
    ...
    <tr>
      <td align="center" bgcolor="#e9ecef">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
              <h2 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">Self-IsoMate: We got a request to reset your Self-IsoMate Password </h2>
              <h3>Need to reset the password? Just fill the form below:</h3>
          </tr>
        </table>
        <!--[if (gte mso 9)|(IE)]>
        </td>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
              <p style="margin: 0;">If you did not make this request, please close this page.</p>
            </td>
          </tr>
          <!-- end permission -->
          ...
          <tr>
            <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
              <p style="margin: 0;">Technical errors? To report any issue or to contact us, please email <a href="mailto:info@self-isomate.online" target="_blank">info@self-isomate.online</a></p>
